export const UI = {
  tr: {
    ...
    sections:{quickTools:"Hızlı Araçlar",featured:"Öne Çıkan Makaleler",categories:"Kategoriler",allArticles:"Tüm Makaleler",tools:"İnteraktif Araçlar",atlas:"Gümüş Atlası",calculator:"Hızlı Hesaplayıcı",jewelryTypes:"Takı Tipi ile Keşfet"},
    ...
    footer:{version:"JewelPedi v4.5 · Kıymetli Metal & Taş Ansiklopedisi",license:"CC BY-NC-SA 4.0",sponsor:"Sponsor: İstanbul Gümüş · Konya",kids:"Çocuklar İçin · JewelPedi Kids"},
  ...
  en: {
    ...
    sections:{quickTools:"Quick Tools",featured:"Featured Articles",categories:"Categories",allArticles:"All Articles",tools:"Interactive Tools",atlas:"Silver Atlas",calculator:"Quick Calculator",jewelryTypes:"Explore by Jewelry Type"},
    ...
    footer:{version:"JewelPedi v4.5 · Precious Metals & Gemstone Encyclopedia",license:"CC BY-NC-SA 4.0",sponsor:"Sponsor: İstanbul Gümüş · Konya",kids:"For Kids · JewelPedi Kids"},
  ...
  ar: {
    ...
    sections:{quickTools:"أدوات سريعة",featured:"مقالات مميزة",categories:"الفئات",allArticles:"جميع المقالات",tools:"أدوات تفاعلية",atlas:"أطلس الفضة",calculator:"حاسبة سريعة",jewelryTypes:"استكشف حسب نوع المجوهرات"},
    ...
    footer:{version:"JewelPedi v4.5 · موسوعة المعادن والأحجار الكريمة",license:"CC BY-NC-SA 4.0",sponsor:"الراعي: إسطنبول غوموش · قونيا",kids:"للأطفال · جواهر بيدي"},
