...
export default function Hero({ lang, onOpenTool, onSelectJewelryType }) {
  ...
  // Arabic-Indic numeral rendering for AR locale
  const arCount = String(articleCount).replace(/[0-9]/g, d => '٠١٢٣٤٥٦٧٨٩'[d]);
  const FEATURES = {
    tr: [`${articleCount} Makale · 3 Dil`, '47 İnteraktif Araç', '297 Harita Noktası', 'Canlı Fiyat Takibi'],
    en: [`${articleCount} Articles · 3 Languages`, '47 Interactive Tools', '297 Map Points', 'Live Price Tracking'],
    ar: [`${arCount} مقال · ٣ لغات`, '٤٧ أداة تفاعلية', '٢٩٧ نقطة خريطة', 'تتبع الأسعار المباشر'],
  }[lang] || [];
